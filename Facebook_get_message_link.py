...
class FBbot2():
    ...
    def sub_send_message(self,):
        ...
        text_btn.click()
        actions = ActionChains(self.driver).send_keys('สวัสดีปีใหม่นะครับ ~🍻🥳 ขอให้มีสุขภาพที่แข็งแรง มีความสุขกับหน้าที่การงาน มีเวลาเหลือเฟื้อกับเรื่องที่รัก'+Keys.ENTER)
        actions.perform()
